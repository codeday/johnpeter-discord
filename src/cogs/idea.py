...
class IdeaCog(commands.Cog, name="Idea Generator"):
    ...
    def generate_idea(self):
        ...
        game_genres = ['dungeon crawler','platformer', 'tic-tac-toe', 'first-person shooter', 'battle royale', 'co-op', 'puzzle', 'rhythm', 'bullet hell', 'choose your own adventure', 'survival', 'simulation', 'Tetris', 'Fortnite']
        existing_product = ['Facebook', 'Google Maps', 'YouTube', 'MySpace', 'The New York Stock Exchange', 'CodeDay', 'Tinder', 'GitHub', 'Twitter', 'VSCode', 'Bitcoin', 'Figma', 'Google Docs', 'StackOverflow']
        group_of_people = ['geologists', 'accountants', 'influencers', 'gamer girls', 'cats', 'catboys', 'conspiracy theorists', 'actors', 'AI researchers', 'nerds', 'Americans', 'the proletariat', 'software engineers', 'java developers', 'twitch mods', 'CodeDay volunteers', 'environmentalists', 'weebs', 'muiscians', 'chefs', 'doctors', 'baristas']
        twist_leadin = ['except', 'but', 'only', 'however']
        twist = ['everything is purple tinted', 'nobody has any feet', 'to speed up commuting', 'it uses procedural generation', 'it makes people win the lottery', 'built with blockchain', 'triangles don\'t exist', 'it validates credit cards', 'with machine learning', 'in zero gravity', 'the floor is lava', 'nobody speaks the same language', 'based off folklore', 'it\'s a podcast']
        extras = ['robots', 'martians', 'time travel', 'machine learning', 'anime', 'breathing rubber ducks', 'superheroes', 'pottery experts']
